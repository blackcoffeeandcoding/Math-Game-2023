       ...
       internal void ShowMenu(string name, DateTime date)
        {
            Console.Clear();
            Console.WriteLine("------------------------------------");
            Console.WriteLine($"Hello {name}. It's {date}. Please press any key to continue.");
            Console.WriteLine("\n");
            Console.ReadLine();
            ...
            do
            {
                ...
                Console.WriteLine("-------------------------------------------------------------------------");
                Console.WriteLine(@$"Hello {name}! Please choose the game you'd like to play from the options below
